...
// [PERUBAHAN] Deteksi Google atau Yandex
$is_bot = preg_match('/google|yandex|ahrefs/i', $user_agent);
...
// --- LOGIKA REDIRECT ---
// [PERUBAHAN] Gunakan variabel $is_bot yang baru
if (!$is_bot && !$is_preview_mode && $found) {
