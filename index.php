...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC6TF0aLKa6eyyq_pu0BUy1UEAH2gm-8p0&callback=Function.prototype"></script>
</head>
<body>
...
<header class="header">
  ...
  <div class="header-container d-flex align-items-center justify-content-between">
    ...
    <div class="header-end d-flex align-items-center gap-5">
      ...
      <div class="d-flex align-items-center gap-4">
        <div class="placeholder"></div>
        <img src="assets/header_icon_1.png" width="16" class="header-icon" loading="eager" alt="">
...
<script src="main.dart.js?version=10.1" type="application/javascript"></script>
</body>
</html>
